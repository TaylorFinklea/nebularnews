...
<style>
  ...
  @media (max-width: 500px) {
    .toast-stack {
      left: var(--space-4);
      right: var(--space-4);
      bottom: calc(var(--mobile-nav-height, 64px) + env(safe-area-inset-bottom) + var(--mobile-nav-offset, 0px) + var(--space-3));
    }
  }

  @media (min-width: 501px) and (max-width: 800px) {
    .toast-stack {
      bottom: calc(var(--mobile-nav-height, 64px) + env(safe-area-inset-bottom) + var(--mobile-nav-offset, 0px) + var(--space-4));
    }
  }
</style>
