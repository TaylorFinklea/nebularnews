export type StarterCanonicalTag = {
  id: string;
  name: string;
  slug: string;
};

export const STARTER_CANONICAL_TAGS: StarterCanonicalTag[] = [
  { id: 'tag-artificial-intelligence', name: 'Artificial Intelligence', slug: 'artificial-intelligence' },
  { id: 'tag-generative-ai', name: 'Generative AI', slug: 'generative-ai' },
  { id: 'tag-large-language-models', name: 'Large Language Models', slug: 'large-language-models' },
  { id: 'tag-ai-agents', name: 'AI Agents', slug: 'ai-agents' },
  { id: 'tag-ai-safety', name: 'AI Safety', slug: 'ai-safety' },
  { id: 'tag-conversational-ai', name: 'Conversational AI', slug: 'conversational-ai' },
  { id: 'tag-deep-learning', name: 'Deep Learning', slug: 'deep-learning' },
  { id: 'tag-robotics', name: 'Robotics', slug: 'robotics' },
  { id: 'tag-cybersecurity', name: 'Cybersecurity', slug: 'cybersecurity' },
  { id: 'tag-cloud-infrastructure', name: 'Cloud Infrastructure', slug: 'cloud-infrastructure' },
  { id: 'tag-kubernetes', name: 'Kubernetes', slug: 'kubernetes' },
  { id: 'tag-open-source', name: 'Open Source', slug: 'open-source' },
  { id: 'tag-developer-tools', name: 'Developer Tools', slug: 'developer-tools' },
  { id: 'tag-software-engineering', name: 'Software Engineering', slug: 'software-engineering' },
  { id: 'tag-semiconductors', name: 'Semiconductors', slug: 'semiconductors' },
  { id: 'tag-gpus', name: 'GPUs', slug: 'gpus' },
  { id: 'tag-data-centers', name: 'Data Centers', slug: 'data-centers' },
  { id: 'tag-enterprise-software', name: 'Enterprise Software', slug: 'enterprise-software' },
  { id: 'tag-startups', name: 'Startups', slug: 'startups' },
  { id: 'tag-regulation', name: 'Regulation', slug: 'regulation' },
  { id: 'tag-privacy', name: 'Privacy', slug: 'privacy' },
  { id: 'tag-iot', name: 'IoT', slug: 'iot' },
  { id: 'tag-consumer-hardware', name: 'Consumer Hardware', slug: 'consumer-hardware' },
  { id: 'tag-research', name: 'Research', slug: 'research' }
];

export const DETERMINISTIC_TAG_KEYWORDS_BY_SLUG: Record<string, string[]> = {
